...
$qry="SELECT * , CAST((CURRENT_TIMESTAMP-time_stamp)/100 as INT ) as ago FROM `request` WHERE (CURRENT_TIMESTAMP-time_stamp)/100<30 ";
    ...
    <div class="jumbotron">
        <h4 class="page-header"> Car Notification service for the blind </h4>
            ...
            <div class="row">
                ...
                <?php
                echo "<ul>";
                echo "<li>ID TagNo  station_id checked Arrival Timestamp</li>";
                while ($row=mysqli_fetch_assoc($result)){
                    $val =implode("    ",$row)." minutes ago";
                    echo "<li> {$val }</li>";
                }
                echo "</ul>";
