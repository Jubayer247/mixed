    ...
    <div class="jumbotron">
        ...
        <form method="post" action="validation.php">
            <div class="form-group">
                <label for="formGroupExampleInput">Station ID</label>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="formGroupExampleInput3" placeholder="Area" name="area">
            </div>
            <div class="form-group">
                <label for="formGroupExampleInput2">City</label>
                <input type="text" class="form-control" id="formGroupExampleInput3" placeholder="City" name="city">
            </div>
            <div class="form-group">
                <label for="formGroupExampleInput2">Next Station</label>
                <input type="text" class="form-control" id="formGroupExampleInput3" placeholder="Next Station" name="next_station">
            </div>
            <button type="submit" class="btn btn-primary" name="addStation">ADD STATION</button>
        </form>
