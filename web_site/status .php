...
$qry = "SELECT * , CAST((CURRENT_TIMESTAMP-time_stamp)/100 as UNSIGNED ) as ago FROM `request` JOIN vahicle ON request.request=vahicle.tagNO  WHERE (CURRENT_TIMESTAMP-time_stamp)/100<3000 order by id asc;";
